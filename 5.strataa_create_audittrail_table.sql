...
--
-- Table structure for table `st09_auditlog`
--

DROP TABLE IF EXISTS `st09_auditlog`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `st09_auditlog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11658 DEFAULT CHARSET=utf8 COMMENT='General logging table.';
...
-- Dump completed on 2017-07-20  8:22:19
